...
$classes = ($active ?? false)
            ? 'flex items-center px-4 py-4 text-primary-700 bg-white/60 font-black rounded-2xl shadow-premium border border-white/50 transition-all scale-[1.02] z-10 relative overflow-hidden group'
